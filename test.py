...
def test_model(model_path, loss_model_path, part, add_loss, device):
    ...
    #     test_data_loader = DataLoader(test_set, batch_size=8, shuffle=False, num_workers=0)
    test_data_loader_2021 = DataLoader(test_set_2021, batch_size=8, shuffle=False, num_workers=0)
...
def test(model_dir, add_loss, device):
    ...
    loss_model_path = os.path.join(model_dir, "loss_model_20.pt")
    print(test_model(model_path, loss_model_path, "eval", add_loss, device))
